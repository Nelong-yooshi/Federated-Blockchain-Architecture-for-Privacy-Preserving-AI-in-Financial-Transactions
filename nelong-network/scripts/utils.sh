...
function printHelp() {
  ...
  if [ "$USAGE" == "up" ]; then
    ...
    println
    println "    Flags:"
    println "    -nan <number of organizations and name of n orgs> - Number of organizations to create (default to 2) And name of the orgs (default to Org1, Org2)"
    ...
    println "   \033[0;32mup\033[0m -r -d -verbose"
    println "   \033[0;32mup createChannel\033[0m -ca -c -r -d -verbose"
    println "   \033[0;32mup createChannel\033[0m -bft -c -r -d -verbose"
    println
    println " Examples:"
    println "   network.sh up createChannel -c mychannel "
    println "   network.sh up nan 4 NiHow OHiYoU Hi GoodMorning -c mychannel"
    ...
    println
    println " Examples:"
    println "   network.sh deployCC -ccn basic -ccp ../asset-transfer-basic/chaincode-javascript/ ./"
    println "   network.sh deployCC -ccn mychaincode -ccp ./user/mychaincode -ccv 1"
  ...
  #   println "   network.sh deployCCAAS -ccn basict -ccp ../asset-transfer-basic/chaincode-typescript -ccaasdocker false" 
    ...
    println "   network.sh cc package -ccn basic -ccp chaincode/asset-transfer-basic/go -ccv 1.0.0"
    ...
    println
    println " Possible Mode and flag combinations"
    println "   \033[0;32mup\033[0m -ca -r -d -verbose"
    println "   \033[0;32mup\033[0m -bft -r -d -verbose"
    println "   \033[0;32mup createChannel\033[0m -ca -c -r -d -verbose"
    println "   \033[0;32mup createChannel\033[0m -bft -c -r -d -verbose"
    println "   \033[0;32mcreateChannel\033[0m -bft -c -r -d -verbose"
    println "   \033[0;32mdeployCC\033[0m -ccn -ccv -ccs -ccp -cci -r -d -verbose"
    println
    println " Examples:"
    println "   network.sh up createChannel -ca -c mychannel"
    println "   network.sh createChannel -c channelName"
    println "   network.sh deployCC -ccn basic -ccp ../asset-transfer-basic/chaincode-javascript/"
    println "   network.sh deployCC -ccn mychaincode -ccp ./user/mychaincode -ccv 1"
  fi
